...
const CryptoDetails = () => {
  ...
  //   console.log(coinId);
  const { coinData, getCoinData, currency } = useContext(cryptoContext);
  ...
  return (
    <div
      onClick={closeModal}
      className="fixed top-0 left-0 right-0 w-full h-full bg-gray-200 bg-opacity-30 backdrop-blur-sm flex justify-center items-center font-nunito"
    >
      <div
        onClick={(e) => {
        ...
        {coinData ? (
          <div className="w-full h-full flex justify-between  p-4 xl:flex-row flex-col">
            <div className="flex flex-col xl:w-[45%] w-full h-full pr-2">
              ...
              <div className="mt-6 w-full flex justify-between items-start">
                <div>
                  <h4 className="text-sm text-gray-100 capitalize">Price</h4>
                ...
                <div
                  className={`text-sm px-1 ml-2 font-medium rounded uppercase  bg-opacity-25 flex items-center ${
              ...
              <div className="flex justify-between mt-4 w-full">
                ...
                <div>
                  ...
                  <div className="text-sm px-1 ml-2 font-medium rounded uppercase  bg-opacity-25 flex items-center my-1 bg-green text-green">
                  ...
                  <div className="text-sm px-1 ml-2 font-medium rounded uppercase  bg-opacity-25 flex items-center my-1 bg-red text-red">
